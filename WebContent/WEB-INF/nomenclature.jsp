		...
		<div class="col-lg-12 ui-sortable">
		        <div class="box ui-sortable-handle">
		            <header>
		                ...
		                <h5>Nomenclature Table Size : ${ count }  </h5>
		            ...
		            <div id="collapse4" class="body">
		                ...
		                <a href="#createModal" data-toggle="modal" onclick=" $('#createform')[0].reset();"
										...
										data-original-title="" title=""><i class="glyphicon glyphicon-plus"></i>  Nouvelle Nomenclature</a>
							</div>
							</div>
						</div>
						<div class="row">
		                    ...
		                    <th class="sorting" tabindex="0"
												...
												style="width: 266px;">Description</th>
...
<c:forEach items="${ Nomenclatures }" var="Nomenclature">
		                    <tr role="row" class="odd">
		                                <td class=""><c:out value="${ Nomenclature.nom }" /></td>
		                                <td><c:out
...
<a onclick="putData('${ Nomenclature.id }','#viewModal')"
...
onclick="data"><i class="glyphicon glyphicon-eye-open"></i> Afficher</a>
		                                <a href="#updateModal"
										  ...
										  onclick="putData('${ Nomenclature.id }','#updateModal')" >
													<i class="glyphicon glyphicon-edit"></i> Modifier</a>
		                                <a href="#deleteModal"  onclick="putData('${ Nomenclature.id }','#deleteModal')"
													data-toggle="modal"
             ...
             function putData(id,partId){                 
		      ...
		      <!-- #createModal -->		     
                              <jsp:include
			page="/WEB-INF/nomenclature/create.jsp" />                      
		      <!-- /#createModal -->
		      
		      <!-- #updateModal -->		     
                              <jsp:include
			page="/WEB-INF/nomenclature/update.jsp" />                      
		      <!-- /#updateModal -->
		      
		       <!-- #viewModal -->		     
                              <jsp:include
			page="/WEB-INF/nomenclature/view.jsp" />                      
		      <!-- /#viewModal -->
		      
		        <!-- #deleteModal -->		     
                              <jsp:include
			page="/WEB-INF/nomenclature/delete.jsp" />                      
		      <!-- /#deleteModal -->
